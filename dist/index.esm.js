...
var Flex$1 = styled(Box)(templateObject_1$v || (templateObject_1$v = __makeTemplateObject(["\n  display: flex;\n  ", "\n"], ["\n  display: flex;\n  ", "\n"])), flexbox);
...
var SwitchButtonStyled = styled(Button)(templateObject_1$I || (templateObject_1$I = __makeTemplateObject(["\n  padding: 15px;\n  height: 30px;\n  margin-left: auto;\n  margin-right: auto;\n  background-color: transparent;\n  border: 1px solid #fff;\n  margin-right: 10px;\n  vertical-align: sub;\n\n  &.bsc {\n    &:hover:not(:disabled):not(.button--disabled):not(:active) {\n      background-color: #F0B90B;\n    }\n  }\n\n  .text {\n    display: none;\n  }\n\n  @media(min-width:600px) {\n    padding: 15px 20px;\n\n    svg {\n      padding-right: 10px;\n    }\n\n    .text {\n      display: block;\n    }\n\n  }\n"], ["\n  padding: 15px;\n  height: 30px;\n  margin-left: auto;\n  margin-right: auto;\n  background-color: transparent;\n  border: 1px solid #fff;\n  margin-right: 10px;\n  vertical-align: sub;\n\n  &.bsc {\n    &:hover:not(:disabled):not(.button--disabled):not(:active) {\n      background-color: #F0B90B;\n    }\n  }\n\n  .text {\n    display: none;\n  }\n\n  @media(min-width:600px) {\n    padding: 15px 20px;\n\n    svg {\n      padding-right: 10px;\n    }\n\n    .text {\n      display: block;\n    }\n\n  }\n"])));
